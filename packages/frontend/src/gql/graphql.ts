...
export type StarSystemDetailsQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, name: string, position: {x:number;y:number}, discoveryProgress?: number | null, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', id: string, name: string } | null }>, discoveries?: Array<{ __typename: 'ResourceDiscovery', id: string, remainingDeposits: number, miningRate: number, resource: { __typename?: 'Resource', id: string, name: string } } | { __typename: 'UnknownDiscovery', id: string }> | null, resourceDepots?: Array<{ __typename?: 'ResourceDepot', id: string, quantity: number, resource: { __typename?: 'Resource', id: string, name: string } }> | null, populations?: Array<{ __typename?: 'Population', id: string, amount: number }> | null } };
