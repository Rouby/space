...
export type TrackStarSystemSubscription = { __typename?: 'Subscription', trackStarSystem: { __typename?: 'StarSystemUpdateEvent', subject: { __typename?: 'StarSystem', id: string, name: string, currentDevelopmentStance?: DevelopmentStance | null, position: {x:number;y:number}, industry?: number | null, discoveryProgress?: number | null, nextTurnStanceProjection?: { __typename?: 'DevelopmentStanceProjection', industryDelta: number, populationDelta: number } | null, owner?: { __typename?: 'Player', id: string, name: string } | null, colonization?: { __typename?: 'StarSystemColonization', turnsRemaining: number, player: { __typename?: 'Player', id: string, name: string } } | null, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', id: string, name: string } | null }>, discoveries?: Array<{ __typename: 'ResourceDiscovery', id: string, remainingDeposits: number, miningRate: number, resource: { __typename?: 'Resource', id: string, name: string } } | { __typename: 'UnknownDiscovery', id: string }> | null, populations?: Array<{ __typename?: 'Population', id: string, amount: number }> | null } } };
