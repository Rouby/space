...
export type CombatEngagementPanelQuery = { __typename?: 'Query', taskForceEngagement?: { __typename?: 'TaskForceEngagement', id: string, phase: string, currentRound: number, winnerTaskForceId?: string | null, taskForceA: { __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', id: string, name: string } | null }, taskForceB: { __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', id: string, name: string } | null }, participantA: { __typename?: 'TaskForceEngagementParticipantState', taskForceId: string, hp: number, maxHp: number, hand: Array<string>, deckRemaining: number, submittedCardId?: string | null }, participantB: { __typename?: 'TaskForceEngagementParticipantState', taskForceId: string, hp: number, maxHp: number, hand: Array<string>, deckRemaining: number, submittedCardId?: string | null }, roundLog: Array<{ __typename?: 'TaskForceEngagementRoundLogEntry', round: number, attackerTaskForceId: string, targetTaskForceId: string, cardId: string, effectType: string, resolvedValue: number, attackerHpAfter: number, targetHpAfter: number }> } | null };
...
export type StarSystemDetailsQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, name: string, currentDevelopmentStance?: DevelopmentStance | null, position: {x:number;y:number}, industry?: number | null, discoveryProgress?: number | null, industrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, industryPerTurn: number, workRequired: number, workDone: number, completionIndustryBonus: number, queuePosition: number, turnsRemaining: number, etaTurns: number }>, completedIndustrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, completionIndustryBonus: number, completedAtTurn?: number | null }>, nextTurnStanceProjection?: { __typename?: 'DevelopmentStanceProjection', industryDelta: number, populationDelta: number } | null, owner?: { __typename?: 'Player', id: string, name: string } | null, colonization?: { __typename?: 'StarSystemColonization', turnsRemaining: number, player: { __typename?: 'Player', id: string, name: string } } | null, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, combatDeck?: Array<string> | null, constructionDone?: number | null, constructionTotal?: number | null, constructionPerTick?: number | null, owner?: { __typename?: 'Player', id: string, name: string } | null }>, discoveries?: Array<{ __typename: 'ResourceDiscovery', id: string, remainingDeposits: number, miningRate: number, resource: { __typename?: 'Resource', id: string, name: string } } | { __typename: 'UnknownDiscovery', id: string }> | null, populations?: Array<{ __typename?: 'Population', id: string, amount: number }> | null } };

export type CommissionFleetContextQueryVariables = Exact<{
  gameId: Scalars['ID']['input'];
}>;


export type CommissionFleetContextQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, me?: { __typename?: 'Player', id: string, shipDesigns: Array<{ __typename?: 'ShipDesign', id: string, name: string, components: Array<{ __typename?: 'ShipDesignComponent', component: { __typename?: 'ShipComponent', constructionCost: number } }> }> } | null } };
...
export type TrackStarSystemSubscription = { __typename?: 'Subscription', trackStarSystem: { __typename?: 'StarSystemUpdateEvent', subject: { __typename?: 'StarSystem', id: string, name: string, currentDevelopmentStance?: DevelopmentStance | null, position: {x:number;y:number}, industry?: number | null, discoveryProgress?: number | null, industrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, industryPerTurn: number, workRequired: number, workDone: number, completionIndustryBonus: number, queuePosition: number, turnsRemaining: number, etaTurns: number }>, completedIndustrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, completionIndustryBonus: number, completedAtTurn?: number | null }>, nextTurnStanceProjection?: { __typename?: 'DevelopmentStanceProjection', industryDelta: number, populationDelta: number } | null, owner?: { __typename?: 'Player', id: string, name: string } | null, colonization?: { __typename?: 'StarSystemColonization', turnsRemaining: number, player: { __typename?: 'Player', id: string, name: string } } | null, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, combatDeck?: Array<string> | null, constructionDone?: number | null, constructionTotal?: number | null, constructionPerTick?: number | null, owner?: { __typename?: 'Player', id: string, name: string } | null }>, discoveries?: Array<{ __typename: 'ResourceDiscovery', id: string, remainingDeposits: number, miningRate: number, resource: { __typename?: 'Resource', id: string, name: string } } | { __typename: 'UnknownDiscovery', id: string }> | null, populations?: Array<{ __typename?: 'Population', id: string, amount: number }> | null } } };
...
export type ConfigureTaskForceCombatDeckMutationVariables = Exact<{
  input: ConfigureTaskForceCombatDeckInput;
}>;


export type ConfigureTaskForceCombatDeckMutation = { __typename?: 'Mutation', configureTaskForceCombatDeck: { __typename?: 'TaskForce', id: string, combatDeck?: Array<string> | null } };
...
export const ConfigureTaskForceCombatDeckDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ConfigureTaskForceCombatDeck"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ConfigureTaskForceCombatDeckInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"configureTaskForceCombatDeck"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"combatDeck"}}]}}]}}]} as unknown as DocumentNode<ConfigureTaskForceCombatDeckMutation, ConfigureTaskForceCombatDeckMutationVariables>;
