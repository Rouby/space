...
export enum ColonizationGovernance {
  Focus = 'focus',
  Forbid = 'forbid'
}
...
export enum IndustrialProjectType {
  ...
  DeepCoreScanner = 'deep_core_scanner',
  FactoryExpansion = 'factory_expansion',
  FleetDrydock = 'fleet_drydock',
  GravityWellSpire = 'gravity_well_spire',
  HabitationDome = 'habitation_dome',
  OrbitalFoundry = 'orbital_foundry',
  XenoarchaeologyLab = 'xenoarchaeology_lab'
}
...
export enum ResearchMiniGameRiskTag {
  Balanced = 'balanced',
  Risky = 'risky',
  Safe = 'safe'
}

export enum ResearchMiniGameType {
  BreakthroughIncident = 'breakthrough_incident',
  EvidenceTriangulation = 'evidence_triangulation'
}
...
export type StarSystemColonizationPressure = {
  __typename?: 'StarSystemColonizationPressure';
  accumulated: Scalars['Float']['output'];
  etaTurns: Scalars['Int']['output'];
  player: Player;
  pressurePerTurn: Scalars['Float']['output'];
...
export type TurnReport = {
  ...
  colonizationCompleted: Array<TurnReportColonizationCompleted>;
  colonizationPressureChanges: Array<TurnReportColonizationPressureChange>;
...
export type TurnReportColonizationCompleted = {
  __typename?: 'TurnReportColonizationCompleted';
  accumulatedPressure: Scalars['String']['output'];
  pressureThreshold: Scalars['String']['output'];
  starSystem: StarSystem;
};

export type TurnReportColonizationPressureChange = {
  __typename?: 'TurnReportColonizationPressureChange';
  accumulatedPressure: Scalars['String']['output'];
  pressureAdded: Scalars['String']['output'];
  pressureThreshold: Scalars['String']['output'];
  starSystem: StarSystem;
};
...
export type CombatEngagementPanelQuery = { __typename?: 'Query', taskForceEngagement?: { __typename?: 'TaskForceEngagement', id: string, phase: string, currentRound: number, winnerTaskForceId?: string | null, taskForceA: { __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', id: string, name: string, user: { __typename?: 'User', id: string } } | null }, taskForceB: { __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', id: string, name: string, user: { __typename?: 'User', id: string } } | null }, participantA: { __typename?: 'TaskForceEngagementParticipantState', taskForceId: string, hp: number, maxHp: number, shieldHp: number, shieldMaxHp: number, armorRating: number, hand: Array<string>, deckRemaining: number, submittedCardId?: string | null }, participantB: { __typename?: 'TaskForceEngagementParticipantState', taskForceId: string, hp: number, maxHp: number, shieldHp: number, shieldMaxHp: number, armorRating: number, hand: Array<string>, deckRemaining: number, submittedCardId?: string | null }, roundLog: Array<{ __typename?: 'TaskForceEngagementRoundLogEntry', round: number, attackerTaskForceId: string, targetTaskForceId: string, cardId: string, effectType: string, resolvedValue: number, shieldDamage: number, armorAbsorbed: number, hullDamage: number, attackerHpAfter: number, targetHpAfter: number }> } | null };
...
export type CurrentTurnEndedQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, turnNumber: number, me?: { __typename?: 'Player', id: string, turnEnded?: boolean | null } | null, dilemmas: Array<{ __typename?: 'Dilemma', id: string, choosen?: string | null }>, activeTaskForceEngagements: Array<{ __typename?: 'TaskForceEngagement', id: string, phase: string, currentRound: number, participantA: { __typename?: 'TaskForceEngagementParticipantState', submittedCardId?: string | null }, participantB: { __typename?: 'TaskForceEngagementParticipantState', submittedCardId?: string | null }, taskForceA: { __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', user: { __typename?: 'User', id: string } } | null }, taskForceB: { __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', user: { __typename?: 'User', id: string } } | null } }> } };
...
export type ResearchFocusPanelQueryVariables = Exact<{
  gameId: Scalars['ID']['input'];
}>;


export type ResearchFocusPanelQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, turnNumber: number, me?: { __typename?: 'Player', id: string, researchMiniGamePrompt?: { __typename?: 'ResearchMiniGamePrompt', miniGameType: ResearchMiniGameType, targetCategory: ResearchCategory, promptSeed: number, promptTitle: string, promptDescription: string, submitted: boolean, submittedBonus?: number | null, submittedQualityScore?: number | null, submittedConfidenceScore?: number | null, submittedRiskTag?: ResearchMiniGameRiskTag | null, triangulationCards: Array<{ __typename?: 'ResearchMiniGameCard', id: string, label: string, relevance: number, tag: string }>, incidentSteps: Array<{ __typename?: 'ResearchMiniGameIncidentStep', step: number, title: string, safeSuccessChance: number, riskySuccessChance: number }> } | null, currentResearchDirective?: { __typename?: 'PlayerResearchDirective', turnNumber: number, primaryCategory: ResearchCategory, secondaryCategory: ResearchCategory, methodology: ResearchMethodology } | null, researchStates: Array<{ __typename?: 'PlayerResearchState', category: ResearchCategory, phase: ResearchPhase, cumulativeMomentum: number, recentEvidence: number, breakthroughCount: number, pendingOutcomeChoices: Array<{ __typename?: 'ResearchOutcomeChoice', outcomeKey: string, displayName: string, outcomeMode: string, stat: string, modifier: number }> }>, researchOutcomes: Array<{ __typename?: 'PlayerResearchOutcome', id: string, category: ResearchCategory, turnNumber: number, outcomeKey: string, outcomeMode: string, stat: string, modifier: number }> } | null } };

export type SetResearchFocusMutationVariables = Exact<{
  gameId: Scalars['ID']['input'];
  primaryCategory: ResearchCategory;
  secondaryCategory: ResearchCategory;
  methodology: ResearchMethodology;
...
export type SetResearchFocusMutation = { __typename?: 'Mutation', setResearchFocus: { __typename?: 'Player', id: string, currentResearchDirective?: { __typename?: 'PlayerResearchDirective', turnNumber: number, primaryCategory: ResearchCategory, secondaryCategory: ResearchCategory, methodology: ResearchMethodology } | null } };

export type SubmitResearchMiniGameActionMutationVariables = Exact<{
  gameId: Scalars['ID']['input'];
  miniGameType: ResearchMiniGameType;
  targetCategory: ResearchCategory;
  triangulationSupportCardId?: InputMaybe<Scalars['String']['input']>;
...
export type SubmitResearchMiniGameActionMutation = { __typename?: 'Mutation', submitResearchMiniGameAction: { __typename?: 'Player', id: string, researchMiniGamePrompt?: { __typename?: 'ResearchMiniGamePrompt', submitted: boolean, submittedBonus?: number | null, submittedQualityScore?: number | null, submittedConfidenceScore?: number | null, submittedRiskTag?: ResearchMiniGameRiskTag | null } | null } };

export type ChooseResearchOutcomeMutationVariables = Exact<{
  gameId: Scalars['ID']['input'];
  category: ResearchCategory;
  outcomeKey: Scalars['String']['input'];
  outcomeMode: Scalars['String']['input'];
...
export type ChooseResearchOutcomeMutation = { __typename?: 'Mutation', chooseResearchOutcome: { __typename?: 'Player', id: string, researchStates: Array<{ __typename?: 'PlayerResearchState', category: ResearchCategory, phase: ResearchPhase, synthesisProgress: number, breakthroughCount: number }>, researchOutcomes: Array<{ __typename?: 'PlayerResearchOutcome', id: string, category: ResearchCategory, turnNumber: number, outcomeKey: string, outcomeMode: string, stat: string, modifier: number }> } };
...
export type ColonizationManagementContextQueryVariables = Exact<{
  gameId: Scalars['ID']['input'];
}>;


export type ColonizationManagementContextQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, me?: { __typename?: 'Player', id: string } | null } };

export type ColonizationManagementStarSystemQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type ColonizationManagementStarSystemQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, colonizationGovernance?: ColonizationGovernance | null, owner?: { __typename?: 'Player', id: string } | null, colonization?: { __typename?: 'StarSystemColonizationPressure', accumulated: number, threshold: number, pressurePerTurn: number, etaTurns: number, player: { __typename?: 'Player', id: string, name: string } } | null, colonizationPressureSources: Array<{ __typename?: 'ColonizationPressureSourceOption', sourceStarSystemId: string, sourceStarSystemName: string, distance: number, availableIndustry: number, allocatedIndustry: number, populationFactor: number, distanceFactor: number }> } };

export type TrackColonizationManagementStarSystemSubscriptionVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type TrackColonizationManagementStarSystemSubscription = { __typename?: 'Subscription', trackStarSystem: { __typename?: 'StarSystemUpdateEvent', subject: { __typename?: 'StarSystem', id: string, colonizationGovernance?: ColonizationGovernance | null, owner?: { __typename?: 'Player', id: string } | null, colonization?: { __typename?: 'StarSystemColonizationPressure', accumulated: number, threshold: number, pressurePerTurn: number, etaTurns: number, player: { __typename?: 'Player', id: string, name: string } } | null, colonizationPressureSources: Array<{ __typename?: 'ColonizationPressureSourceOption', sourceStarSystemId: string, sourceStarSystemName: string, distance: number, availableIndustry: number, allocatedIndustry: number, populationFactor: number, distanceFactor: number }> } } };

export type SetColonizationGovernanceFromPanelMutationVariables = Exact<{
  starSystemId: Scalars['ID']['input'];
  governance?: InputMaybe<ColonizationGovernance>;
}>;


export type SetColonizationGovernanceFromPanelMutation = { __typename?: 'Mutation', setColonizationGovernance: { __typename?: 'StarSystem', id: string, colonizationGovernance?: ColonizationGovernance | null } };

export type SetColonizationPressureAllocationFromPanelMutationVariables = Exact<{
  targetStarSystemId: Scalars['ID']['input'];
  allocations: Array<ColonizationPressureAllocationInput> | ColonizationPressureAllocationInput;
}>;


export type SetColonizationPressureAllocationFromPanelMutation = { __typename?: 'Mutation', setColonizationPressureAllocation: { __typename?: 'StarSystem', id: string, colonizationPressureSources: Array<{ __typename?: 'ColonizationPressureSourceOption', sourceStarSystemId: string, allocatedIndustry: number }> } };
...
export type CommissionFleetContextPanelQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, me?: { __typename?: 'Player', id: string, shipDesigns: Array<{ __typename?: 'ShipDesign', id: string, name: string, costs: Array<{ __typename?: 'ResourceCost', quantity: number, resource: { __typename?: 'Resource', id: string } }>, components: Array<{ __typename?: 'ShipDesignComponent', component: { __typename?: 'ShipComponent', constructionCost: number } }> }> } | null } };
...
export type DeckConfigurationStarSystemQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, combatDeck?: Array<string> | null, combatProfile: { __typename?: 'CombatProfile', hasWeapons: boolean, hasHeavyWeapons: boolean, hasShields: boolean, hasThrusters: boolean, hasSensors: boolean, hasCrew: boolean, eligibleCardIds: Array<string> } }> } };
...
export type TrackDeckConfigurationStarSystemSubscription = { __typename?: 'Subscription', trackStarSystem: { __typename?: 'StarSystemUpdateEvent', subject: { __typename?: 'StarSystem', id: string, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, combatDeck?: Array<string> | null, combatProfile: { __typename?: 'CombatProfile', hasWeapons: boolean, hasHeavyWeapons: boolean, hasShields: boolean, hasThrusters: boolean, hasSensors: boolean, hasCrew: boolean, eligibleCardIds: Array<string> } }> } } };
...
export type IndustrialProjectsStarSystemQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, owner?: { __typename?: 'Player', id: string } | null, industrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, category: string, description: string, industryPerTurn: number, workRequired: number, workDone: number, completionIndustryBonus: number, maintenanceCost: number, queuePosition: number, turnsRemaining: number, etaTurns: number }>, completedIndustrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, category: string, completionIndustryBonus: number, maintenanceCost: number, completedAtTurn?: number | null }> } };
...
export type TrackIndustrialProjectsStarSystemSubscription = { __typename?: 'Subscription', trackStarSystem: { __typename?: 'StarSystemUpdateEvent', subject: { __typename?: 'StarSystem', id: string, owner?: { __typename?: 'Player', id: string } | null, industrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, category: string, description: string, industryPerTurn: number, workRequired: number, workDone: number, completionIndustryBonus: number, maintenanceCost: number, queuePosition: number, turnsRemaining: number, etaTurns: number }>, completedIndustrialProjects: Array<{ __typename?: 'IndustrialProject', id: string, projectType: IndustrialProjectType, category: string, completionIndustryBonus: number, maintenanceCost: number, completedAtTurn?: number | null }> } } };
...
export type AbandonIndustrialProjectMutationVariables = Exact<{
  projectId: Scalars['ID']['input'];
}>;


export type AbandonIndustrialProjectMutation = { __typename?: 'Mutation', abandonIndustrialProject: { __typename?: 'StarSystem', id: string, completedIndustrialProjects: Array<{ __typename?: 'IndustrialProject', id: string }> } };
...
export type StarSystemDetailsQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, name: string, colonizationGovernance?: ColonizationGovernance | null, currentDevelopmentStance?: DevelopmentStance | null, position: {x:number;y:number}, industry?: number | null, discoveryProgress?: number | null, colonizationPressureSources: Array<{ __typename?: 'ColonizationPressureSourceOption', sourceStarSystemId: string, sourceStarSystemName: string, distance: number, population: number, availableIndustry: number, allocatedIndustry: number, populationFactor: number, distanceFactor: number, projectedPressurePerTurn: number }>, industryBreakdown?: { __typename?: 'IndustryBreakdown', rawIndustry: number, populationCap: number, cappedIndustry: number, maintenance: number, colonizationAllocated: number, netIndustry: number } | null, nextTurnStanceProjection?: { __typename?: 'DevelopmentStanceProjection', industryDelta: number, populationDelta: number } | null, owner?: { __typename?: 'Player', id: string, name: string } | null, colonization?: { __typename?: 'StarSystemColonizationPressure', accumulated: number, threshold: number, pressurePerTurn: number, etaTurns: number, player: { __typename?: 'Player', id: string, name: string } } | null, taskForces: Array<{ __typename?: 'TaskForce', id: string }>, discoveries?: Array<
      | { __typename: 'ResourceDiscovery', id: string, remainingDeposits: number, miningRate: number, resource: { __typename?: 'Resource', id: string, name: string, kind: string, description: string, statBonuses?: Array<{ __typename?: 'ResourceStatBonus', stat: string, modifier: number }> | null } }
...
export type TrackStarSystemDetailsSubscription = { __typename?: 'Subscription', trackStarSystem: { __typename?: 'StarSystemUpdateEvent', subject: { __typename?: 'StarSystem', id: string, name: string, colonizationGovernance?: ColonizationGovernance | null, currentDevelopmentStance?: DevelopmentStance | null, position: {x:number;y:number}, industry?: number | null, discoveryProgress?: number | null, colonizationPressureSources: Array<{ __typename?: 'ColonizationPressureSourceOption', sourceStarSystemId: string, sourceStarSystemName: string, distance: number, population: number, availableIndustry: number, allocatedIndustry: number, populationFactor: number, distanceFactor: number, projectedPressurePerTurn: number }>, industryBreakdown?: { __typename?: 'IndustryBreakdown', rawIndustry: number, populationCap: number, cappedIndustry: number, maintenance: number, colonizationAllocated: number, netIndustry: number } | null, nextTurnStanceProjection?: { __typename?: 'DevelopmentStanceProjection', industryDelta: number, populationDelta: number } | null, owner?: { __typename?: 'Player', id: string, name: string } | null, colonization?: { __typename?: 'StarSystemColonizationPressure', accumulated: number, threshold: number, pressurePerTurn: number, etaTurns: number, player: { __typename?: 'Player', id: string, name: string } } | null, taskForces: Array<{ __typename?: 'TaskForce', id: string }>, discoveries?: Array<
        | { __typename: 'ResourceDiscovery', id: string, remainingDeposits: number, miningRate: number, resource: { __typename?: 'Resource', id: string, name: string, kind: string, description: string, statBonuses?: Array<{ __typename?: 'ResourceStatBonus', stat: string, modifier: number }> | null } }
        | { __typename: 'UnknownDiscovery', id: string }
      > | null, populations?: Array<{ __typename?: 'Population', id: string, amount: number }> | null } } };
...
export type TaskForcesStarSystemQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, mission: TaskForceMission, combatDeck?: Array<string> | null, constructionDone?: number | null, constructionTotal?: number | null, constructionPerTick?: number | null, owner?: { __typename?: 'Player', id: string, name: string } | null, shipDesigns: Array<{ __typename?: 'TaskForceShipDesign', quantity: number, design: { __typename?: 'ShipDesign', name: string } }> }> } };
...
export type TrackTaskForcesStarSystemSubscription = { __typename?: 'Subscription', trackStarSystem: { __typename?: 'StarSystemUpdateEvent', subject: { __typename?: 'StarSystem', id: string, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, mission: TaskForceMission, combatDeck?: Array<string> | null, constructionDone?: number | null, constructionTotal?: number | null, constructionPerTick?: number | null, owner?: { __typename?: 'Player', id: string, name: string } | null, shipDesigns: Array<{ __typename?: 'TaskForceShipDesign', quantity: number, design: { __typename?: 'ShipDesign', name: string } }> }> } } };

export type AssignTaskForceMissionMutationVariables = Exact<{
  taskForceId: Scalars['ID']['input'];
  mission: TaskForceMission;
}>;


export type AssignTaskForceMissionMutation = { __typename?: 'Mutation', assignTaskForceMission: { __typename?: 'TaskForce', id: string, mission: TaskForceMission } };
...
export type TurnReportsDetailsQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, turnReports: Array<{ __typename?: 'TurnReport', id: string, turnNumber: number, createdAt: any, populationChanges: Array<{ __typename?: 'TurnReportPopulationChange', previousAmount: number, newAmount: number, growth: number, starSystem: { __typename?: 'StarSystem', id: string, name: string }, population: { __typename?: 'Population', id: string } }>, populationMigrations: Array<{ __typename?: 'TurnReportPopulationMigration', amount: number, sourceStarSystem: { __typename?: 'StarSystem', id: string, name: string }, destinationStarSystem: { __typename?: 'StarSystem', id: string, name: string }, allegiancePlayer: { __typename?: 'User', id: string, name: string } }>, miningChanges: Array<{ __typename?: 'TurnReportMiningChange', mined: number, remainingDeposits: number, depotQuantity: number, starSystem: { __typename?: 'StarSystem', id: string, name: string }, resource: { __typename?: 'Resource', id: string, name: string } }>, industryChanges: Array<{ __typename?: 'TurnReportIndustryChange', industryTotal: number, industryUtilized: number, starSystem: { __typename?: 'StarSystem', id: string, name: string } }>, industrialProjectCompletions: Array<{ __typename?: 'TurnReportIndustrialProjectCompletion', projectType: IndustrialProjectType, industryBonus: number, starSystem: { __typename?: 'StarSystem', id: string, name: string } }>, taskForceConstructionChanges: Array<{ __typename?: 'TurnReportTaskForceConstructionChange', previousDone: number, newDone: number, total: number, perTick: number, completed: boolean, taskForce: { __typename?: 'TaskForce', id: string, name: string }, starSystem: { __typename?: 'StarSystem', id: string, name: string } }>, taskForceEngagements: Array<{ __typename?: 'TurnReportTaskForceEngagement', engagementId: string, status: string, taskForceAId: string, taskForceBId: string, taskForceAName: string, taskForceBName: string, winnerTaskForceId?: string | null, location: {x:number;y:number} }>, colonizationPressureChanges: Array<{ __typename?: 'TurnReportColonizationPressureChange', pressureAdded: string, accumulatedPressure: string, pressureThreshold: string, starSystem: { __typename?: 'StarSystem', id: string, name: string } }>, colonizationCompleted: Array<{ __typename?: 'TurnReportColonizationCompleted', accumulatedPressure: string, pressureThreshold: string, starSystem: { __typename?: 'StarSystem', id: string, name: string } }>, researchProgressChanges: Array<{ __typename?: 'TurnReportResearchProgressChange', category: ResearchCategory, momentumGained: string, totalMomentum: string, phase: ResearchPhase, phaseChanged: boolean }>, researchBreakthroughs: Array<{ __typename?: 'TurnReportResearchBreakthrough', category: ResearchCategory, outcomeKey: string, outcomeMode: string, stat: string, modifier: string }> }> } };
...
export const ResearchFocusPanelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ResearchFocusPanel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"game"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"turnNumber"}},{"kind":"Field","name":{"kind":"Name","value":"me"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"researchMiniGamePrompt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"miniGameType"}},{"kind":"Field","name":{"kind":"Name","value":"targetCategory"}},{"kind":"Field","name":{"kind":"Name","value":"promptSeed"}},{"kind":"Field","name":{"kind":"Name","value":"promptTitle"}},{"kind":"Field","name":{"kind":"Name","value":"promptDescription"}},{"kind":"Field","name":{"kind":"Name","value":"triangulationCards"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"label"}},{"kind":"Field","name":{"kind":"Name","value":"relevance"}},{"kind":"Field","name":{"kind":"Name","value":"tag"}}]}},{"kind":"Field","name":{"kind":"Name","value":"incidentSteps"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"step"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"safeSuccessChance"}},{"kind":"Field","name":{"kind":"Name","value":"riskySuccessChance"}}]}},{"kind":"Field","name":{"kind":"Name","value":"submitted"}},{"kind":"Field","name":{"kind":"Name","value":"submittedBonus"}},{"kind":"Field","name":{"kind":"Name","value":"submittedQualityScore"}},{"kind":"Field","name":{"kind":"Name","value":"submittedConfidenceScore"}},{"kind":"Field","name":{"kind":"Name","value":"submittedRiskTag"}}]}},{"kind":"Field","name":{"kind":"Name","value":"currentResearchDirective"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"turnNumber"}},{"kind":"Field","name":{"kind":"Name","value":"primaryCategory"}},{"kind":"Field","name":{"kind":"Name","value":"secondaryCategory"}},{"kind":"Field","name":{"kind":"Name","value":"methodology"}}]}},{"kind":"Field","name":{"kind":"Name","value":"researchStates"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"cumulativeMomentum"}},{"kind":"Field","name":{"kind":"Name","value":"recentEvidence"}},{"kind":"Field","name":{"kind":"Name","value":"breakthroughCount"}},{"kind":"Field","name":{"kind":"Name","value":"pendingOutcomeChoices"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"outcomeKey"}},{"kind":"Field","name":{"kind":"Name","value":"displayName"}},{"kind":"Field","name":{"kind":"Name","value":"outcomeMode"}},{"kind":"Field","name":{"kind":"Name","value":"stat"}},{"kind":"Field","name":{"kind":"Name","value":"modifier"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"researchOutcomes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"20"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"turnNumber"}},{"kind":"Field","name":{"kind":"Name","value":"outcomeKey"}},{"kind":"Field","name":{"kind":"Name","value":"outcomeMode"}},{"kind":"Field","name":{"kind":"Name","value":"stat"}},{"kind":"Field","name":{"kind":"Name","value":"modifier"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ResearchFocusPanelQuery, ResearchFocusPanelQueryVariables>;
export const SetResearchFocusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetResearchFocus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"primaryCategory"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ResearchCategory"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"secondaryCategory"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ResearchCategory"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"methodology"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ResearchMethodology"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setResearchFocus"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}},{"kind":"Argument","name":{"kind":"Name","value":"primaryCategory"},"value":{"kind":"Variable","name":{"kind":"Name","value":"primaryCategory"}}},{"kind":"Argument","name":{"kind":"Name","value":"secondaryCategory"},"value":{"kind":"Variable","name":{"kind":"Name","value":"secondaryCategory"}}},{"kind":"Argument","name":{"kind":"Name","value":"methodology"},"value":{"kind":"Variable","name":{"kind":"Name","value":"methodology"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"currentResearchDirective"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"turnNumber"}},{"kind":"Field","name":{"kind":"Name","value":"primaryCategory"}},{"kind":"Field","name":{"kind":"Name","value":"secondaryCategory"}},{"kind":"Field","name":{"kind":"Name","value":"methodology"}}]}}]}}]}}]} as unknown as DocumentNode<SetResearchFocusMutation, SetResearchFocusMutationVariables>;
export const SubmitResearchMiniGameActionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubmitResearchMiniGameAction"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"miniGameType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ResearchMiniGameType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"targetCategory"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ResearchCategory"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"triangulationSupportCardId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"triangulationConflictCardId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"triangulationControlCardId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"incidentStepOneRisky"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"incidentStepTwoRisky"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"incidentStepThreeRisky"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"submitResearchMiniGameAction"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}},{"kind":"Argument","name":{"kind":"Name","value":"miniGameType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"miniGameType"}}},{"kind":"Argument","name":{"kind":"Name","value":"targetCategory"},"value":{"kind":"Variable","name":{"kind":"Name","value":"targetCategory"}}},{"kind":"Argument","name":{"kind":"Name","value":"triangulationSupportCardId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"triangulationSupportCardId"}}},{"kind":"Argument","name":{"kind":"Name","value":"triangulationConflictCardId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"triangulationConflictCardId"}}},{"kind":"Argument","name":{"kind":"Name","value":"triangulationControlCardId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"triangulationControlCardId"}}},{"kind":"Argument","name":{"kind":"Name","value":"incidentStepOneRisky"},"value":{"kind":"Variable","name":{"kind":"Name","value":"incidentStepOneRisky"}}},{"kind":"Argument","name":{"kind":"Name","value":"incidentStepTwoRisky"},"value":{"kind":"Variable","name":{"kind":"Name","value":"incidentStepTwoRisky"}}},{"kind":"Argument","name":{"kind":"Name","value":"incidentStepThreeRisky"},"value":{"kind":"Variable","name":{"kind":"Name","value":"incidentStepThreeRisky"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"researchMiniGamePrompt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"submitted"}},{"kind":"Field","name":{"kind":"Name","value":"submittedBonus"}},{"kind":"Field","name":{"kind":"Name","value":"submittedQualityScore"}},{"kind":"Field","name":{"kind":"Name","value":"submittedConfidenceScore"}},{"kind":"Field","name":{"kind":"Name","value":"submittedRiskTag"}}]}}]}}]}}]} as unknown as DocumentNode<SubmitResearchMiniGameActionMutation, SubmitResearchMiniGameActionMutationVariables>;
export const ChooseResearchOutcomeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ChooseResearchOutcome"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"category"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ResearchCategory"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"outcomeKey"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"outcomeMode"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"chooseResearchOutcome"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"gameId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}},{"kind":"Argument","name":{"kind":"Name","value":"category"},"value":{"kind":"Variable","name":{"kind":"Name","value":"category"}}},{"kind":"Argument","name":{"kind":"Name","value":"outcomeKey"},"value":{"kind":"Variable","name":{"kind":"Name","value":"outcomeKey"}}},{"kind":"Argument","name":{"kind":"Name","value":"outcomeMode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"outcomeMode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"researchStates"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"phase"}},{"kind":"Field","name":{"kind":"Name","value":"synthesisProgress"}},{"kind":"Field","name":{"kind":"Name","value":"breakthroughCount"}}]}},{"kind":"Field","name":{"kind":"Name","value":"researchOutcomes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"20"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"turnNumber"}},{"kind":"Field","name":{"kind":"Name","value":"outcomeKey"}},{"kind":"Field","name":{"kind":"Name","value":"outcomeMode"}},{"kind":"Field","name":{"kind":"Name","value":"stat"}},{"kind":"Field","name":{"kind":"Name","value":"modifier"}}]}}]}}]}}]} as unknown as DocumentNode<ChooseResearchOutcomeMutation, ChooseResearchOutcomeMutationVariables>;
export const ShipComponentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ShipComponents"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"game"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"me"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"shipComponents"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"costs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resource"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"quantity"}}]}},{"kind":"Field","name":{"kind":"Name","value":"supplyNeedPassive"}},{"kind":"Field","name":{"kind":"Name","value":"supplyNeedMovement"}},{"kind":"Field","name":{"kind":"Name","value":"supplyNeedCombat"}},{"kind":"Field","name":{"kind":"Name","value":"powerNeed"}},{"kind":"Field","name":{"kind":"Name","value":"crewNeed"}},{"kind":"Field","name":{"kind":"Name","value":"constructionCost"}},{"kind":"Field","name":{"kind":"Name","value":"supplyCapacity"}},{"kind":"Field","name":{"kind":"Name","value":"powerGeneration"}},{"kind":"Field","name":{"kind":"Name","value":"crewCapacity"}},{"kind":"Field","name":{"kind":"Name","value":"ftlSpeed"}},{"kind":"Field","name":{"kind":"Name","value":"zoneOfControl"}},{"kind":"Field","name":{"kind":"Name","value":"sensorRange"}},{"kind":"Field","name":{"kind":"Name","value":"structuralIntegrity"}},{"kind":"Field","name":{"kind":"Name","value":"thruster"}},{"kind":"Field","name":{"kind":"Name","value":"sensorPrecision"}},{"kind":"Field","name":{"kind":"Name","value":"armorThickness"}},{"kind":"Field","name":{"kind":"Name","value":"armorEffectivenessAgainst"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projectile"}},{"kind":"Field","name":{"kind":"Name","value":"missile"}},{"kind":"Field","name":{"kind":"Name","value":"beam"}},{"kind":"Field","name":{"kind":"Name","value":"instant"}}]}},{"kind":"Field","name":{"kind":"Name","value":"shieldStrength"}},{"kind":"Field","name":{"kind":"Name","value":"shieldEffectivenessAgainst"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"projectile"}},{"kind":"Field","name":{"kind":"Name","value":"missile"}},{"kind":"Field","name":{"kind":"Name","value":"beam"}},{"kind":"Field","name":{"kind":"Name","value":"instant"}}]}},{"kind":"Field","name":{"kind":"Name","value":"weaponDamage"}},{"kind":"Field","name":{"kind":"Name","value":"weaponCooldown"}},{"kind":"Field","name":{"kind":"Name","value":"weaponRange"}},{"kind":"Field","name":{"kind":"Name","value":"weaponArmorPenetration"}},{"kind":"Field","name":{"kind":"Name","value":"weaponShieldPenetration"}},{"kind":"Field","name":{"kind":"Name","value":"weaponAccuracy"}},{"kind":"Field","name":{"kind":"Name","value":"weaponDeliveryType"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ShipComponentsQuery, ShipComponentsQueryVariables>;
...
export const ColonizationManagementContextDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ColonizationManagementContext"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"game"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"me"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<ColonizationManagementContextQuery, ColonizationManagementContextQueryVariables>;
export const ColonizationManagementStarSystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ColonizationManagementStarSystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"starSystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"owner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"colonizationGovernance"}},{"kind":"Field","name":{"kind":"Name","value":"colonization"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accumulated"}},{"kind":"Field","name":{"kind":"Name","value":"threshold"}},{"kind":"Field","name":{"kind":"Name","value":"pressurePerTurn"}},{"kind":"Field","name":{"kind":"Name","value":"etaTurns"}},{"kind":"Field","name":{"kind":"Name","value":"player"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"colonizationPressureSources"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sourceStarSystemId"}},{"kind":"Field","name":{"kind":"Name","value":"sourceStarSystemName"}},{"kind":"Field","name":{"kind":"Name","value":"distance"}},{"kind":"Field","name":{"kind":"Name","value":"availableIndustry"}},{"kind":"Field","name":{"kind":"Name","value":"allocatedIndustry"}},{"kind":"Field","name":{"kind":"Name","value":"populationFactor"}},{"kind":"Field","name":{"kind":"Name","value":"distanceFactor"}}]}}]}}]}}]} as unknown as DocumentNode<ColonizationManagementStarSystemQuery, ColonizationManagementStarSystemQueryVariables>;
export const TrackColonizationManagementStarSystemDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"TrackColonizationManagementStarSystem"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"trackStarSystem"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"starSystemId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StarSystemUpdateEvent"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"subject"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"owner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"colonizationGovernance"}},{"kind":"Field","name":{"kind":"Name","value":"colonization"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"accumulated"}},{"kind":"Field","name":{"kind":"Name","value":"threshold"}},{"kind":"Field","name":{"kind":"Name","value":"pressurePerTurn"}},{"kind":"Field","name":{"kind":"Name","value":"etaTurns"}},{"kind":"Field","name":{"kind":"Name","value":"player"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"colonizationPressureSources"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sourceStarSystemId"}},{"kind":"Field","name":{"kind":"Name","value":"sourceStarSystemName"}},{"kind":"Field","name":{"kind":"Name","value":"distance"}},{"kind":"Field","name":{"kind":"Name","value":"availableIndustry"}},{"kind":"Field","name":{"kind":"Name","value":"allocatedIndustry"}},{"kind":"Field","name":{"kind":"Name","value":"populationFactor"}},{"kind":"Field","name":{"kind":"Name","value":"distanceFactor"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<TrackColonizationManagementStarSystemSubscription, TrackColonizationManagementStarSystemSubscriptionVariables>;
export const SetColonizationGovernanceFromPanelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetColonizationGovernanceFromPanel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"starSystemId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"governance"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ColonizationGovernance"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setColonizationGovernance"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"starSystemId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"starSystemId"}}},{"kind":"Argument","name":{"kind":"Name","value":"governance"},"value":{"kind":"Variable","name":{"kind":"Name","value":"governance"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"colonizationGovernance"}}]}}]}}]} as unknown as DocumentNode<SetColonizationGovernanceFromPanelMutation, SetColonizationGovernanceFromPanelMutationVariables>;
export const SetColonizationPressureAllocationFromPanelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetColonizationPressureAllocationFromPanel"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"targetStarSystemId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"allocations"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ColonizationPressureAllocationInput"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setColonizationPressureAllocation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"targetStarSystemId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"targetStarSystemId"}}},{"kind":"Argument","name":{"kind":"Name","value":"allocations"},"value":{"kind":"Variable","name":{"kind":"Name","value":"allocations"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"colonizationPressureSources"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sourceStarSystemId"}},{"kind":"Field","name":{"kind":"Name","value":"allocatedIndustry"}}]}}]}}]}}]} as unknown as DocumentNode<SetColonizationPressureAllocationFromPanelMutation, SetColonizationPressureAllocationFromPanelMutationVariables>;
