...
export type TurnReportsDetailsQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, starSystems: Array<{ __typename?: 'StarSystem', id: string, name: string }>, resources: Array<{ __typename?: 'Resource', id: string, name: string }>, turnReports: Array<{ __typename?: 'TurnReport', id: string, turnNumber: number, createdAt: any, populationChanges: Array<{ __typename?: 'TurnReportPopulationChange', starSystemId: string, populationId: string, previousAmount: number, newAmount: number, growth: number }>, miningChanges: Array<{ __typename?: 'TurnReportMiningChange', starSystemId: string, resourceId: string, mined: number, remainingDeposits: number, depotQuantity: number }> }> } };

export type TurnReportsQueryVariables = Exact<{
  gameId: Scalars['ID']['input'];
}>;


export type TurnReportsQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, turnReports: Array<{ __typename?: 'TurnReport', id: string, turnNumber: number, createdAt: any, populationChanges: Array<{ __typename?: 'TurnReportPopulationChange', starSystemId: string, populationId: string, previousAmount: number, newAmount: number, growth: number }>, miningChanges: Array<{ __typename?: 'TurnReportMiningChange', starSystemId: string, resourceId: string, mined: number, remainingDeposits: number, depotQuantity: number }> }> } };
