...
export type TaskForceMovementsSubscription = { __typename?: 'Subscription', trackTaskForces: { __typename?: 'TaskForce', id: string, position: {x:number;y:number}, movementVector?: {x:number;y:number} | null, orders: Array<{ __typename?: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string, type: TaskForceOrderType }>, game: { __typename?: 'Game', id: string } } };
...
export type UpdateCacheQueryVariables = Exact<{
  gameId: Scalars['ID']['input'];
}>;


export type UpdateCacheQuery = { __typename?: 'Query', game: { __typename?: 'Game', taskForces: Array<{ __typename?: 'TaskForce', id: string, position: {x:number;y:number} }> } };
...
export const UpdateCacheDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"UpdateCache"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"game"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gameId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"taskForces"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"position"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateCacheQuery, UpdateCacheQueryVariables>;
