...
export type GalaxyQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, starSystems: Array<{ __typename?: 'StarSystem', id: string, position: {x:number;y:number}, isVisible: boolean, lastUpdate?: any | null, owner?: { __typename?: 'Player', id: string, name: string, color: string } | null }>, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, position: {x:number;y:number}, movementVector?: {x:number;y:number} | null, isVisible: boolean, lastUpdate?: any | null, owner?: { __typename?: 'Player', id: string, name: string, color: string } | null, orders?: Array<{ __typename?: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string }> | null }> } };
...
export type StarSystemDetailsQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, name: string, position: {x:number;y:number}, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, owner?: { __typename?: 'Player', id: string, name: string } | null }>, discoveries?: Array<{ __typename?: 'ResourceDiscovery', id: string, remainingDeposits: number, resource: { __typename?: 'Resource', id: string, name: string } }> | null, resourceDepots?: Array<{ __typename?: 'ResourceDepot', id: string, quantity: number, resource: { __typename?: 'Resource', id: string, name: string } }> | null } };
