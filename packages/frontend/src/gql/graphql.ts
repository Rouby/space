...
export type GalaxyQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, starSystems: Array<{ __typename?: 'StarSystem', id: string, position: {x:number;y:number}, owner?: { __typename?: 'User', id: string, name: string } | null }>, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, position: {x:number;y:number}, owner: { __typename?: 'User', id: string, name: string }, orders: Array<{ __typename?: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string, type: TaskForceOrderType }> }> } };
...
export type TaskForceMovementsSubscription = { __typename?: 'Subscription', trackTaskForces: { __typename?: 'TaskForce', id: string, position: {x:number;y:number}, orders: Array<{ __typename?: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string, type: TaskForceOrderType }> } };
