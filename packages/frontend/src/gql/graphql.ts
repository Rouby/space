...
export type GalaxyQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, starSystems: Array<{ __typename?: 'StarSystem', id: string, position: {x:number;y:number}, owner?: { __typename?: 'Player', id: string, name: string, color: string } | null }>, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, position: {x:number;y:number}, movementVector?: {x:number;y:number} | null, owner: { __typename?: 'Player', id: string, name: string, color: string }, orders: Array<{ __typename?: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string }> }> } };
...
export type MoveTaskForceMutation = { __typename?: 'Mutation', moveTaskForce?: { __typename?: 'TaskForce', id: string, orders: Array<{ __typename?: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string }> }, queueTaskForceMove?: { __typename?: 'TaskForce', id: string, orders: Array<{ __typename?: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string }> } };
...
export type TrackMapSubscription = { __typename?: 'Subscription', trackGalaxy: { __typename?: 'PositionableApppearsEvent', subject: { __typename: 'StarSystem', id: string, position: {x:number;y:number} } | { __typename: 'TaskForce', movementVector?: {x:number;y:number} | null, id: string, position: {x:number;y:number} } } | { __typename?: 'PositionableDisappearsEvent', subject: { __typename: 'StarSystem', id: string, position: {x:number;y:number} } | { __typename: 'TaskForce', id: string, position: {x:number;y:number} } } | { __typename?: 'PositionableMovesEvent', subject: { __typename: 'StarSystem', id: string, position: {x:number;y:number} } | { __typename: 'TaskForce', movementVector?: {x:number;y:number} | null, id: string, position: {x:number;y:number} } } };
...
export type ShipDesignsQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, me?: { __typename?: 'Player', id: string, shipDesigns: Array<{ __typename?: 'ShipDesign', id: string, name: string }> } | null } };
...
export type StarSystemDetailsQuery = { __typename?: 'Query', starSystem: { __typename?: 'StarSystem', id: string, name: string, position: {x:number;y:number}, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, owner: { __typename?: 'Player', id: string, name: string } }>, discoveries: Array<{ __typename?: 'ResourceDiscovery', id: string, remainingDeposits: number, resource: { __typename?: 'Resource', id: string, name: string } }>, resourceDepots: Array<{ __typename?: 'ResourceDepot', id: string, quantity: number, resource: { __typename?: 'Resource', id: string, name: string } }> } };
