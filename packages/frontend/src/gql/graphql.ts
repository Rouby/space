...
export type GalaxyQuery = { __typename?: 'Query', game: { __typename?: 'Game', id: string, starSystems: Array<{ __typename?: 'StarSystem', id: string, position: {x:number;y:number}, isVisible: boolean, lastUpdate?: any | null, sensorRange?: number | null, owner?: { __typename?: 'Player', id: string, name: string, color: string } | null }>, taskForces: Array<{ __typename?: 'TaskForce', id: string, name: string, position: {x:number;y:number}, constructionDone?: number | null, constructionTotal?: number | null, movementVector?: {x:number;y:number} | null, isVisible: boolean, lastUpdate?: any | null, sensorRange?: number | null, owner?: { __typename?: 'Player', id: string, name: string, color: string } | null, orders?: Array<{ __typename: 'TaskForceColonizeOrder', id: string } | { __typename: 'TaskForceFollowOrder', id: string } | { __typename: 'TaskForceMoveOrder', destination: {x:number;y:number}, id: string }> | null }>, dilemmas: Array<{ __typename?: 'Dilemma', id: string, title: string, question: string, description: string, choosen?: string | null, position?: {x:number;y:number} | null, choices: Array<{ __typename?: 'DilemmaChoice', id: string, title: string, description: string }>, correlation?: { __typename?: 'Dilemma', id: string, title: string } | { __typename?: 'StarSystem', id: string, position: {x:number;y:number} } | null }> } };
