...
import    { Vector } from './planet/resolvers/Vector.js';
    export const resolvers: Resolvers = {
      Query: { games: Query_games,me: Query_me,planets: Query_planets },
      Mutation: { createGame: Mutation_createGame,loginWithPassword: Mutation_loginWithPassword,loginWithRefreshToken: Mutation_loginWithRefreshToken,registerWithPassword: Mutation_registerWithPassword },
