...
Intel system is disabled. To activate:
  ...
  node /home/rouby/space/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /home/rouby/space/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /home/rouby/space/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /home/rouby/space/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /home/rouby/space/.opencode/get-shit-done/bin/gsd-tools.cjs
