...
- **Global scope**: `/home/rouby/space/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/rouby/space/.opencode/notes/`)
...
2. Glob `/home/rouby/space/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/rouby/space/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/rouby/space/.opencode/notes/` — works in any directory
