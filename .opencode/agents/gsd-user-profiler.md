...
<reference>
@/home/rouby/space/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/rouby/space/.opencode/get-shit-done/references/user-profiling.md` to load:
